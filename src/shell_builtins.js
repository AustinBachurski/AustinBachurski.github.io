...
export const builtin = {
    'help': [
        ...
        { style: htmlText, text: '<span class="bright-green">cat</span><span class="dim-text"> - Concatenate files and print on the standard output.</span>' },
        { style: htmlText, text: '<span class="bright-green">exit</span><span class="dim-text"> - Exit this terminal.</span>' },
    ]
};
