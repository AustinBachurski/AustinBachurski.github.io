...
export const helpContent = [
    new NormalGreenLine("JAB bach, version 0.1.12 (like bash, but strictly worse...)"),
    new NormalGreenLine("These shell commands are defined internally.  Type 'help' to see this list."),
    new NormalGreenLine("Type 'help command' to find out more about the function 'comamnd'."),
